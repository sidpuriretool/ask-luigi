    ...
    <div className="min-h-screen bg-[#f8f8f4] text-slate-900">
      ...
      <main className="mx-auto w-full max-w-md px-4 py-16">
        ...
        <p className="mt-1 text-sm text-slate-600">
          Sign in with your Google account to use Codex.
        </p>
        ...
        <div className="mt-8 rounded-2xl border border-slate-200 bg-white p-6">
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-full border border-slate-300 bg-white px-5 py-3 text-sm font-semibold text-slate-800 shadow-sm transition hover:border-slate-400 hover:bg-slate-50"
          >
